function Header() {
    return (
        ...
        <div className='d-flex align-center'>
          <img width={40} height={40} src='/img/icon-logo.svg'></img>
          <div>
          <div>
        ...
        <ul className='d-flex'>
          <li className='mr-30'>
            <img width={18} height={18} src='/img/icon-basket-buy.svg'></img>
            <span>1205 руб.</span>
          </li>
          <li>
            {/* в svg можно поменять цвет иконки */}
            ...
            <img width={20} height={20} src='/img/icon-user.svg'></img>
          </li>
        </ul>
      </header>
    )
